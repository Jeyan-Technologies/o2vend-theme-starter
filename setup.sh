...
if command -v code &> /dev/null; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "⚠️  Failed to install extension. Install manually from VS Code Extensions marketplace."
        echo ""
    fi
else
    ...
    echo "   3. Search for 'O2VEND Language Support'"
